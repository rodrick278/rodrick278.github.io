...
![image.png](https://cdn.nlark.com/yuque/0/2020/png/2735301/1603689505725-c2405866-7586-4343-870a-927ce22cc767.png)
**而变量存储的不是对象自身，而是该对象的“内存地址”，换句话说就是一个对该对象的“引用”**
![image.png](https://cdn.nlark.com/yuque/0/2020/png/2735301/1603689308768-a38b90df-3daf-4f3b-abb9-904c60b9e48c.png)
...
```
此时两个变量引用的是同一个对象
![image.png](https://cdn.nlark.com/yuque/0/2020/png/2735301/1603689397107-031733c1-0802-4a73-991c-2386f29c084e.png)
**
**所以我们需要：**
...
console.log(objCopy);
```
![image.png](https://cdn.nlark.com/yuque/0/2020/png/2735301/1603690485283-85a77a73-d0dd-4f08-92e0-b1ce3bb2a99e.png)
可以看出，确实只有第一层是真正的“拷贝”
...
console.log(arrCopy);
```
![image.png](https://cdn.nlark.com/yuque/0/2020/png/2735301/1603690976213-78024e0a-5f38-4452-9ac9-6e84160cbd01.png)
...
console.log(objCopy);
```
![image.png](https://cdn.nlark.com/yuque/0/2020/png/2735301/1603692410602-6cc796bf-b8f6-47a7-97de-b81e0d6371dd.png)
拷贝后函数丢失
